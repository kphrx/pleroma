...
defmodule Pleroma.Web.Streamer do
  ...
  defp match_irreversible_filter(user, object, stream_type) do
  ...
  defp irreversible_regex(user, :notification), do: Pleroma.Filter.compose_regex(user, "notifications", :re)
